...
- [Four-Season Crop Rotation Plan](crop-rotation.3md) - `crop-rotation.3md`
...
- [Household Budget Q1](life-monthly-budget.3md) - `life-monthly-budget.3md`
- [ACL Reconstruction - Recovery Timeline](med-acl-recovery.3md) - `med-acl-recovery.3md`
- [Daily Medication Schedule - Polypharmacy Plan](med-medication-schedule.3md) - `med-medication-schedule.3md`
- [Migraine Symptom Diary - Episode Phases](med-migraine-diary.3md) - `med-migraine-diary.3md`
- [Inpatient Chart - Rivera, J. (MRN 0048-2291)](med-patient-chart.3md) - `med-patient-chart.3md`
- [5-Day Strength Program - Hypertrophy Block, Week 3](med-strength-program.3md) - `med-strength-program.3md`
- [Daily Medication Schedule](medication-schedule.3md) - `medication-schedule.3md`
- [Q3 Platform Sync - Weekly Engineering Meeting](meeting-agenda.3md) - `meeting-agenda.3md`
- [The Lunar Cycle, Phase by Phase](moon-phases.3md) - `moon-phases.3md`
- [Signal Drift - Season 2 Episode Guide](podcast-season.3md) - `podcast-season.3md`
...
- [Rocket Launch](game-rocket-launch.3md) - `game-rocket-launch.3md`
- [Snake](game-snake.3md) - `game-snake.3md`
- [EKG Heartbeat ASCII Animation](heartbeat.3md) - `heartbeat.3md`
- [ASCII Loading Spinner](loading-spinner.3md) - `loading-spinner.3md`
- [ECG Lead II - One Cardiac Cycle (Animated)](med-ecg-animation.3md) - `med-ecg-animation.3md`
- [Ode to Joy - First Phrase by Measure](music-score.3md) - `music-score.3md`
- [Swinging Pendulum](pendulum.3md) - `pendulum.3md`
- [Falling Rain](rain.3md) - `rain.3md`
- [ASCII Jump Sprite Sequence](sprite-jump.3md) - `sprite-jump.3md`
- [Traffic Light State Animation](traffic-light.3md) - `traffic-light.3md`
...
- [Octahedron Slices](game-3d-diamond.3md) - `game-3d-diamond.3md`
- [Brief in Opposition to Summary Judgment](legal-brief.3md) - `legal-brief.3md`
- [Head CT - Axial Slices (Superior to Inferior)](med-brain-ct-slices.3md) - `med-brain-ct-slices.3md`
- [City Council Approves Riverside Flood Barrier](news-pyramid.3md) - `news-pyramid.3md`
- [Progressive Product Onboarding](onboarding.3md) - `onboarding.3md`
- [Sparse Attention Routing for Long-Context Transformers](paper-abstract.3md) - `paper-abstract.3md`
- [One-Pan Lemon Garlic Chicken](recipe-depth.3md) - `recipe-depth.3md`
- [Ada Byron - Resume](resume.3md) - `resume.3md`
- [Stormcaller Skill Tree](skill-tree.3md) - `skill-tree.3md`
...
- [Server Rack and Network Map: Rack B](data-server-rack.3md) - `data-server-rack.3md`
- [The Sunken Vault](dungeon.3md) - `dungeon.3md`
- [Maple Cottage - Floor Plan](floor-plan.3md) - `floor-plan.3md`
- [The Hedge Maze](game-maze.3md) - `game-maze.3md`
...
- [Maplewood Court - Unit Stack (Line 04)](apartment-stack.3md) - `apartment-stack.3md`
- [Halcyon DC-2 - Rack Layout by Row](data-center.3md) - `data-center.3md`
- [Mercy General Hospital - Floor Guide](hospital-wings.3md) - `hospital-wings.3md`
- [The Larkspur Hotel - Amenities by Floor](hotel-amenities.3md) - `hotel-amenities.3md`
- [Maplewood Central Library - Floor Guide](library-floors.3md) - `library-floors.3md`
- [Maple Street House Tour](life-house-tour.3md) - `life-house-tour.3md`
- [Riverbend Galleria - Store Directory](mall-directory.3md) - `mall-directory.3md`
- [Meridian Tower - Building Directory](office-directory.3md) - `office-directory.3md`
- [Cedar Street Garage - Levels P1 to P5](parking-levels.3md) - `parking-levels.3md`
- [Anatomy of a Three-Stage Launch Vehicle](rocket-stages.3md) - `rocket-stages.3md`
- [MS Corvid Aurora - Deck Plan](ship-decks.3md) - `ship-decks.3md`

## axis: slide (10)

- [Build a URL Shortener in Python](coding-tutorial.3md) - `coding-tutorial.3md`
- [Helios Analytics - Live Product Demo](demo-script.3md) - `demo-script.3md`
- [Building for the Edge - Conference Keynote Outline](keynote.3md) - `keynote.3md`
- [Why Does the Moon Change Shape?](lesson-plan.3md) - `lesson-plan.3md`
- [Ship It Before You Read It: Trust Your Test Suite](lightning-talk.3md) - `lightning-talk.3md`
- [Driftwood - Inventory Intelligence for Independent Cafes](pitch-deck.3md) - `pitch-deck.3md`
- [Q2 2026 Quarterly Business Review](quarterly-review.3md) - `quarterly-review.3md`
- [Outbound Sales Call Script - Acme Analytics](sales-script.3md) - `sales-script.3md`
- [The Prodigal Son - Coming Home](sermon.3md) - `sermon.3md`
- [A Toast to Mara and Devin](wedding-toast.3md) - `wedding-toast.3md`

## axis: status (7)

- [The Lifecycle of a Bug](bug-lifecycle.3md) - `bug-lifecycle.3md`
- [Content Production Pipeline](content-calendar.3md) - `content-calendar.3md`
- [Checkout Service Deployment Pipeline](deploy-stages.3md) - `deploy-stages.3md`
- [Grant Application Pipeline](grant-stages.3md) - `grant-stages.3md`
- [Senior Backend Engineer - Hiring Funnel](hiring-pipeline.3md) - `hiring-pipeline.3md`
- [Sprint 14 Board](kanban.3md) - `kanban.3md`
- [Order Fulfillment Pipeline](order-fulfillment.3md) - `order-fulfillment.3md`

## axis: version (5)

- [Landing Headline A/B/C Test](ab-variants.3md) - `ab-variants.3md`
- [Payments API across v1, v2, and v3](api-versions.3md) - `api-versions.3md`
- [Database Migration Sequence](data-db-migrations.3md) - `data-db-migrations.3md`
